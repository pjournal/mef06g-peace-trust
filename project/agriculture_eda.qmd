...
To find how dense are the cities in terms of agriculture, we must find total areas of each cities, I used [Wikipedia](https://en.wikipedia.org/wiki/Provinces_of_Turkey) as a data source,
First 5 columns are from Wikipedia, geographic locations of each city is taken with geopy library pf Pyhton, and also it's important to mention that Area is in km2.
...
knitr::kable(head(df_area_to_ag),caption = "Density of Agricultural Areas (Agricultural Area/Area)  Top(5)")
```
